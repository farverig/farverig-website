...
@media (min-width:1051px){
  ...
  .booking-section{display:flex !important;flex-direction:column !important;grid-template-columns:none !important;grid-template-rows:none !important;min-height:calc(100vh + .75rem) !important;align-items:stretch !important;margin-top:40vh !important;padding:clamp(8rem,11vh,11rem) clamp(5rem,8vw,9rem) clamp(4rem,5.5vh,5rem) !important;}
  ...
  .booking-cta-space{height:clamp(7.4rem,10.2vh,9rem) !important;}
  .booking-contact{width:100% !important;margin:0 !important;text-align:left !important;white-space:nowrap !important;transform:translateY(clamp(.45rem,.8vh,.7rem)) !important;}
