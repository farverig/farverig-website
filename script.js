...
.book-button span:first-child{white-space:nowrap;}.book-button .book-arrow{display:none !important;}.book-button:hover{transform:translateX(-50%) translateY(-2px);}.book-button.is-form-state{min-width:clamp(12.5rem,15vw,15rem);backdrop-filter:blur(14px);opacity:1 !important;bottom:clamp(1.15rem,1.8vh,1.6rem) !important;}.book-button.is-form-state.is-incomplete,.book-button.is-form-state.is-ready{opacity:1 !important;}.book-button.is-success{min-width:clamp(14rem,19vw,19rem);}
