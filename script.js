...
@media (min-width:1051px){
  ...
  .booking-section{display:flex !important;flex-direction:column !important;grid-template-columns:none !important;grid-template-rows:none !important;min-height:calc(100vh + 2.75rem) !important;align-items:stretch !important;margin-top:40vh !important;padding:clamp(8rem,11vh,11rem) clamp(5rem,8vw,9rem) clamp(4rem,5.5vh,5rem) !important;}
...
.book-button{left:50% !important;right:auto !important;bottom:clamp(1.55rem,2.1vh,1.9rem) !important;transform:translateX(-50%);min-width:clamp(17rem,22vw,22rem);justify-content:center;padding-left:1.4rem !important;padding-right:1.4rem !important;transition:background .25s,color .25s,opacity .25s,border-color .25s,transform .25s,min-width .25s,bottom .25s;}
.book-button span:first-child{white-space:nowrap;}.book-button .book-arrow{display:none !important;}.book-button:hover{transform:translateX(-50%) translateY(-2px);}.book-button.is-form-state{min-width:clamp(12.5rem,15vw,15rem);backdrop-filter:blur(14px);opacity:1 !important;bottom:clamp(1.55rem,2.1vh,1.9rem) !important;}.book-button.is-form-state.is-incomplete,.book-button.is-form-state.is-ready{opacity:1 !important;}.book-button.is-success{min-width:clamp(14rem,19vw,19rem);}
