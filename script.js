...
.book-button{left:50% !important;right:auto !important;bottom:clamp(.9rem,1.4vh,1.25rem) !important;transform:translateX(-50%);min-width:clamp(17rem,22vw,22rem);justify-content:center;padding-left:1.4rem !important;padding-right:1.4rem !important;transition:background .25s,color .25s,opacity .25s,border-color .25s,transform .25s,min-width .25s,bottom .25s;}
.book-button span:first-child{white-space:nowrap;}.book-button .book-arrow{display:none !important;}.book-button:hover{transform:translateX(-50%) translateY(-2px);}.book-button.is-form-state{min-width:clamp(12.5rem,15vw,15rem);backdrop-filter:blur(14px);opacity:1 !important;bottom:clamp(.9rem,1.4vh,1.25rem) !important;}.book-button.is-form-state.is-incomplete,.book-button.is-form-state.is-ready{opacity:1 !important;}.book-button.is-success{min-width:clamp(14rem,19vw,19rem);}
