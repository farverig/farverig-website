(()=>{
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .seen-us-inner{position:relative;z-index:8;padding-inline:clamp(1.15rem,3vw,3rem)}
